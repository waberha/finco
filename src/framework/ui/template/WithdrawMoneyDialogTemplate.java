...
public final class WithdrawMoneyDialogTemplate extends JDialog {

    private MainframeTemplate parentframe;
    private String accnr;

    public WithdrawMoneyDialogTemplate(MainframeTemplate parent, WithdrawMoneyDialogPlugin dialogPlugin, WithdrawMoneyDialogListener dialogListener, String aaccnr) {
        super(parent);
        parentframe = parent;
        accnr = aaccnr;
        ...
        JButton_Calcel.addActionListener(dialogListener);
    }
