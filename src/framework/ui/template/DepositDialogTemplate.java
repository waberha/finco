...
public final class DepositDialogTemplate extends JDialog {
    ...
    DepositDialogTemplate(MainFrameTemplate parent, String aaccnr, DepositDialogPlugin depositDialogPlugin) {
        super(parent);
        parentframe = parent;
        accnr = aaccnr;
        ...
        //{{ INIT_CONTROLS
        setTitle(depositDialogPlugin.getDialogName());
        setModal(true);
        getContentPane().setLayout(null);
        setSize(268, 126);
        setVisible(false);
        JLabel1.setText(depositDialogPlugin.getAccountIdentifierName());
